 ...
 *
 * @note: This feature requires Varjo Base Pro license when used with #varjo_StreamType_DistortedColor, _EnvironmentCubemap or _EyeCamera
 *
 * Possible errors:
 ...
 *
 * Note: Use varjo_GetCameraIntrinsics2 instead.
 * Note: This struct type is deprecated because of limited support for camera models.
 *
 * Possible errors:
 *     #varjo_Error_OperationFailed, #varjo_Error_NotAvailable, #varjo_Error_CapabilityNotAvailable,
 ...
 */
VARJO_DEPRECATED_API struct varjo_CameraIntrinsics varjo_GetCameraIntrinsics(
 ...
 * @return camera intrinsics for the frame or unspecified value if the frame does not have intrinsics.
 */
VARJO_API struct varjo_CameraIntrinsics2 varjo_GetCameraIntrinsics2(
    struct varjo_Session* session, varjo_StreamId id, int64_t frameNumber, varjo_ChannelIndex index);
