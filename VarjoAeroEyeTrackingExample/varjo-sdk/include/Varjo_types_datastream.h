...
static const varjo_IntrinsicsModel varjo_IntrinsicsModel_Rational = 2;  //!< OpenCV compatible Rational calibration model.
 ...
 * - Intrinsics (access with #varjo_GetCameraIntrinsics2)
 * - Extrinsics (access with #varjo_GetCameraExtrinsics)
 *
 * @note: This feature requires Varjo Base Pro license.
 */
...
/**
 * Camera intrinsics parameter for undistorting a distorted camera frame.
 * Distortion coefficients for omnidir: 2 radial, skew, xi, 2 tangential.
 * For rational: 4 radial, 2 tangential, and 2 extra elements as rational coefficients.
 */
